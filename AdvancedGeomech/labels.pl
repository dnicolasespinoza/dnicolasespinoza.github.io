...
$key = q/fig:Biot/;
$external_latex_labels{$key} = q|3.2 Schematic cross section of reservoir model for depletion|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:DevWell/;
$external_latex_labels{$key} = q|5.3 Example of shale dis-equilibrium compaction evidenced by porosity deviation from the normal compaction trend (image source: Gordon and Flemings, 1998 <kbd><A ID="tex2html2"
...
$key = q/fig:FracStress2/;
$external_latex_labels{$key} = q|5.1 Peak stress measured from triaxial tests (image source: Jaeger et al. 2007 - FRM 4th Ed)|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:PKNequations/;
$external_latex_labels{$key} = q|8.1 Example waveforms plotted with increasing deviatoric stress|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:StressShadow/;
$external_latex_labels{$key} = q|6.1 $S_Hmax$ direction around a propped hydraulic fracture (Roussel and Sharma, 2011)|; 
$noresave{$key} = "$nosave";
