...
$key = q/fig:HFTS2BouyantFrac/;
$ref_files{$key} = "$dir".q|node9.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:HFTS2OpticFiber/;
$ref_files{$key} = "$dir".q|node9.html|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:MicroseismicityHFTS2/;
$ref_files{$key} = "$dir".q|node9.html|; 
$noresave{$key} = "$nosave";
